...
1. Upload Package
    ...
    ```bash
    scp ./cyberx-data-node-7.1.0-1.el7.x86_64.rpm root@hostname:~/
    scp ./cyberx-client-node-7.1.0-1.el7.x86_64.rpm root@hostname:~/
    ```

1. Install CyberX Data Node

    ```bash
    yum install ./cyberx-data-node-7.1.0-1.el7.x86_64.rpm
    ```
...
1. Install CyberX Client Node 
    ...
    ```bash
    yum install ./cyberx-client-node-7.1.0-1.el7.x86_64.rpm
    ```
